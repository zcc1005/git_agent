...
5. Return event times and representative frames from the detector output. Do not synthesize observations.
6. Use the returned deterministic risk result and alarm state.
